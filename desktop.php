...
<h3>
<i class="fa fa-desktop"></i> <span style="font-weight: bolder">Desktop PCs</span>
</h3>
                
                <table>  
                <?php
                $connect = mysqli_connect("localhost", "root", "albarkaat", "pubg");    
                $query = "SELECT * FROM tbl_images WHERE category = 'desktop' ORDER BY id DESC";  
                ...
                echo '<b><a title="'.$row['productname'].'" href="item.php?id=' .$row['id']. '"><div class="text ellipsis"><span class="text-concat">'.$row['productname'] .'</span></div></a>Rs. ' .number_format($row['productcost']);
